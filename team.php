...
<html lang="en">
  ...
  <head>
    ...
    <title>SportPort - #1 Website For Organizing Intramurals Sports</title>
...
<!--             <li class="nav-item mx-0 mx-lg-1">
            ...
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contact">Login / Sign Up</a>
            </li>
          </ul>
        </div>
      </div>
...
<section style=>
<h1>Team</h1>
    <p>This will show a specific team from a league</p>
</section>
