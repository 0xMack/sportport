...
class Game{ //Stores game information
    ...
    public function __construct($gameID, $aTeamID, $bTeamID, $aTeamScore, $bTeamScore, $date){
        $this->gameID = trim($gameID);
...
function game_db_to_dto($game_db){
    $game_dto = new Game($game_db['GameID'], $game_db['AteamID'], $game_db['BteamID'],
